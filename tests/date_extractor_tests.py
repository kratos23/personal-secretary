...
import date_extractor_package
from date_extractor_package import Message


class DateExtractorTestCase(unittest.TestCase):
    _date_extractor = date_extractor_package.DateExtractor()
    ...
    def _extract_date(self, messages: [Message]):
        return self._date_extractor.extract_date(date_extractor_package.DateExtractorInput(messages))
